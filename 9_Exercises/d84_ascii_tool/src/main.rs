...
// Build a fun CLI tool that generates procedural ASCII art patterns using Rust’s math 
// and loops. You’ll learn to combine randomness, characters, and geometry to create 
// beautiful or quirky ASCII visuals.
// Key Concepts:
// + ASCII brightness mapping using math
// + rand::Rng for procedural generation
// + Sine/cosine wave functions to simulate patterns
// + Print to terminal using print!() + manual newline
// You’ve created a procedural visual generator—a foundation for generative art, 
// terminal UIs, or data visualizations.
