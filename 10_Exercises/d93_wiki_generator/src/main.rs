...
// Create a tool that scans a folder of .md files, builds a navigable HTML wiki, 
// and generates an index of links. You’ll combine directory walking, Markdown 
// rendering, and template generation.
// Key Concepts:
...
// You now have a personal offline Markdown wiki—great for documentation, knowledge 
// bases, or local publishing.
