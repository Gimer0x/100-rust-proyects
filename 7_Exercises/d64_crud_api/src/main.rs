...
// Build a fully functional CRUD API for a Post resource using Actix-Web, storing data 
// in-memory. You’ll learn to handle GET, POST, PUT, DELETE requests—core operations in 
// any RESTful service.

// Key Concepts:
// + Full CRUD routing with RESTful conventions
// + Mutex<HashMap> to store dynamic state
// + Pattern matching for 404 vs success responses
// You’ve built a complete REST API for posts—foundational for blogs, microservices, 
// admin panels, or any CRUD app.
