...
// Build a foundational E-commerce backend that supports products, orders, and customers. 
// You’ll create a RESTful API using Actix-Web + PostgreSQL with relations, data validation, 
// and full CRUD for multiple entities.
// Key Concepts:
// + Real-world DB schema modeling
// + Product and customer creation
// + Easily extendable to orders & payments
// You’ve now built the foundation for a full-scale E-commerce backend—perfect for SaaS products, 
// online stores, and inventory apps.
...
async fn main() -> std::io::Result<()> {
    ...
    println!("E-Commerce API running at http://localhost:8080");
